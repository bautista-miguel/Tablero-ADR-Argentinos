...
def load_cache(tickers):
    ...
    # Pandas puede inferir columnas completamente vacías como float64.
    # Las fechas ISO y estados son texto, por lo que deben ser object
    # antes de asignar strings como "2026-09-03".
    text_columns = [
        "Próximo earnings",
        "Estado fecha earnings",
        "Último reporte",
